					...
					<div class="panel-body">
						<form class="form-horizontal" action="<%=insertUrl%>" id="myform" method="post">
							<fieldset>
								...
								<div class="form-group" id="user.role.ridDiv">
									<!-- 定义表单提示文字 -->
									<label class="col-md-3 control-label" for="user.role.rid">具备角色：</label>
									<div class="col-md-5">
										<select id="user.role.rid" name="user.role.rid" class="form-control">
											<option value="1">信息管理员角色</option>
											<option value="2">超级管理员角色</option>
										</select>
									</div>
									<!-- 定义表单错误提示显示元素 -->
									<div class="col-md-4" id="user.role.ridMsg"></div>
								</div>
