				...
				<div class="panel panel-success">
					...
					<div class="panel-body">
						<table class="table table-bordered table-hover">
							<tr>
								<td colspan="3"><span class="h1"><span class="glyphicon glyphicon-user"></span>&nbsp;欢迎<span style="color:red;">${admin.mid}</span>光临！</span></td>
							</tr>
							<tr>
								<td rowspan="4" style="width:130px;">
									<img src="<%=basePath %>/upload/user/${admin.photo}" class="image" style="height:128px;width:128px;">
								</td>
							</tr>
							<tr>
