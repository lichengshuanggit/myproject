								...
								<tbody>
									<tr>
										...
										<td class="text-center">
											<input type="text" id="title-1" name="title-1" class="form-control input-sm" value="开发资料">
										</td>
										<td class="text-center">
									...
									<tr>
										...
										<td class="text-center">
											<input type="text" id="title-2" name="title-2" class="form-control input-sm" value="技术学习">
										</td>
										<td class="text-center">
									...
									<tr>
										...
										<td class="text-center">
											<input type="text" id="title-3" name="title-3" class="form-control input-sm" value="项目管理">
										</td>
										<td class="text-center">
