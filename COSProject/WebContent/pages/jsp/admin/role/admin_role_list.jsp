					...
					<div class="panel-body">
						<table class="table table-bordered table-hover table-condensed">
							...
							<tbody>
							    ...
							    <c:forEach items="${allRoles}" var="rol">
								<tr>
									<td class="text-center">${rol.rid}</td> 
									<td class="text-center"><span id="title-${rol.rid}">${rol.title}</span></td>
									<td class="text-center"><span id="note-${rol.rid}">${rol.note}</span></td>
									<td class="text-center"> 
										<button class="btn btn-primary" id="updateBtn-${rol.rid}"><span class="glyphicon glyphicon-edit"></span>&nbsp;修改</button>
									</td>
								</tr>
								</c:forEach>
								</c:if>
